...
- **190'dan fazla karakter** — ~140 saha lordu ve ~55 **leydi**, 36 hanedana dağılmış. Her hanedanda en az 3-4 lord, en az bir leydi ve onlarca çocuk vardır; **tek kişilik hanedan bırakılmaz** — üyesi azalan hanedana uzak akraba katılır ya da hanedan büyük bir haneyle birleşir
- **Leydiler** — sarayda yaşarlar, sefere çıkmazlar ama hanedanın parçasıdırlar: evlenir, çocuk büyütür, kurultayda oy kullanırlar. Hanedanın başına geçen leydi tahta da çıkabilir; o zaman sahaya iner ve ordusunu kurar
- **Aile ağacı büyür** — bir lord öldüğünde yalnız varisi değil, yetişkin diğer çocukları da hanedana katılır (erkekler saha lordu, kızlar leydi olarak); hanedanlar nesiller boyu genişler
...
- **Sandbox'tan hanedan yönetimi** — sıfırdan **hanedan kur** (isim, renk, arma deseni ve sembolü, kaç lord kaç leydi), hanedana **lord/leydi ekle**, bir lordun **hanedanını değiştir**, hanedanı **başka krallığa taşı** ya da **dağıt** (üyeleri başka hanedanlara dağılsın, sürgüne gitsin ya da soyu kırılsın)
